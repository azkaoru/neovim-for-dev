...
wk.add({
	...
	{ "<space>dd", "<cmd>lua require'dap'.disconnect()<cr>",                                                  desc = "Disconnect",                    mode = "n" },
	{ "<space>dc",       "<cmd>lua require'dap'.continue()<cr>",                                                    desc = "Continue",                      mode = "n" },
	{ "<space>dt", "<cmd>lua require'dap'.terminate()<cr>",                                                   desc = "Terminate",                     mode = "n" },
	{ "<space>dr", "<cmd>lua require'dap'.repl.toggle()<cr>",                                                 desc = "Open REPL",                     mode = "n" },
	{ "<space>dl", "<cmd>lua require'dap'.run_last()<cr>",                                                    desc = "Run last",                      mode = "n" },
	{ "<space>di", function() require "dap.ui.widgets".hover() end,                                           desc = "Variables",                     mode = "n" },
	{ "<leader>d",  group = "DAPUI" }, -- group
	{ "<leader>dt", "<cmd>lua require('dapui').toggle()<cr>",                                                    desc = "DAPUI toggle",                      mode = "n" },
	{ "<leader>dc", "<cmd>lua require('dapui').close('sidebar')<cr>",                                                    desc = "DAPUI close",                      mode = "n" },
	{
		"<leader>d?",
		function()
